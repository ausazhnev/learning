...
# элемент содержит имя из списка names в качестве ключа и длинну этого имени в качестве значения
...
# напишите инструкцию с использованием включения в словаррь, для создания второго словаря,
# содержащего элументы телефонной книги phonebook, которые имеют значения начинающиеся с '919'
