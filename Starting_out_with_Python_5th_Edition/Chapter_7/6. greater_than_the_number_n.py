...
# Допустим, что список содержит числа. Функция должна показать все числа в списке, которые
# больше чем 'n'
#
#
# Task (EN)
...
# Let's assume that the list contains numbers. The function should show all the numbers in
