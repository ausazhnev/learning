...
class Car(Automobile):
    ...
    def __init__(self, make, model, mileage, price, doors):
        ...
        # требуемые атрибуты. Обратите внимание, что мы так же
        # передаем self в качестве аргумента.
        Automobile.__init__(self, make, model, mileage, price)
        # Инициализируем атрибут __doors.
        self.__doors = doors

    # Метод set_doors является методом-мутатором
    # атрибута __doors.
...
class Truck(Automobile):
    # Метод __init__ принимает аргументы для фирмы-изготовителя,
    # модели, пробега цены и типа привода пикапа.
    def __init__(self, make, model, mileage, price, drive_type):
        ...
        # Инициализируем атрибут __drive_type.
        self.__drive_type = drive_type

    # Метод set_drive_type является методом-мутатором
...
class SUV(Automobile):
    # Метод __init__ принимает аргументы для фирмы-изготовителя,
    # модели, пробега цены и типа привода джипа.
    ...
    # Метод set_pass_cap является методом-мутатором
    # атрибута __pass_cap.
