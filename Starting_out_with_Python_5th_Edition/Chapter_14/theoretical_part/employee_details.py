...
class EmployeeDetails:
    ...
    def __build_main_window(self):
        ...
        # Скомпилировать рамку виджета Listbox
    ...
    # Скомпилировать рамку, содержащую виджетов Listbox и Scrollbar
    ...
    # Создать вертикальный виджет Scrollbar для использования в виджетом Listbox
    ...
    def __get_employees(self):
        ...
        conn = None
        try:
            # Присоединиться к базе данных и получить курсор
